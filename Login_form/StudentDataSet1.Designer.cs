...
namespace Login_form.StudentDataSet1TableAdapters {
    ...
    public partial class CourseTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM [dbo].[Course] WHERE (([ID] = @Original_ID) AND ([Label] = @Original_" +
                "Label) AND ([Period] = @Original_Period) AND ([Description] = @Original_Descript" +
                "ion))";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[Course] SET [ID] = @ID, [Label] = @Label, [Period] = @Period, [Description] = @Description WHERE (([ID] = @Original_ID) AND ([Label] = @Original_Label) AND ([Period] = @Original_Period) AND ([Description] = @Original_Description));
SELECT ID, Label, Period, Description FROM Course WHERE (ID = @ID)";
        ...
        public virtual int Delete(string Original_ID, string Original_Label, int Original_Period, string Original_Description) {
            if ((Original_ID == null)) {
        ...
        public virtual int Update(string ID, string Label, int Period, string Description, string Original_ID, string Original_Label, int Original_Period, string Original_Description) {
            if ((ID == null)) {
                throw new global::System.ArgumentNullException("ID");
            }
            else {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string Label, int Period, string Description, string Original_ID, string Original_Label, int Original_Period, string Original_Description) {
            return this.Update(Original_ID, Label, Period, Description, Original_ID, Original_Label, Original_Period, Original_Description);
        }
    }
